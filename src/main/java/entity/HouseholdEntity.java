...
public class HouseholdEntity {
	...
	public String toString() {
		return "HouseholdEntity [id=" + id + ", geographicArea=" + geographicArea + ", householdType=" + householdType
				+ ", householdSize=" + householdSize + ", householdsByAgeRange=" + householdsByAgeRange
				+ ", householdEarners=" + householdEarners + ", totalIncome=" + totalIncome + ", censusYear="
				+ censusYear + ", numberReported=" + numberReported + "]";
	}
